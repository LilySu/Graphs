...
class Graph:
	...
	def dfs_recursive(self, start_vert, target_value, visited=None, path=None): #target value, what we are looking, path is what we see when we look back
		print(start_vert)
		...
		path = path + [start_vert] # makes a copy of a new list
